...
<body>
	...
	<div class="container">
		...
		<header class="masthead">
			<h1 class="muted"><center>Cadastro de Usuarios</h1></center>
			<nav class="navbar">
		...
		<form method="post" action="">
			...
			<div class="input-prepend">
				...
				<input type="text" name="setor" value="<?php echo $resultado->setor; ?>" placeholder="Setor:" />
			</div>
...
<div id="rodape">
<p>
Todos Direitos Reservados – <a href="https://www.facebook.com/DaniloKanny"><strong>Danilo Kanny</strong></a> 
</p>
</div>
